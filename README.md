## ament_black (jazzy) - 0.2.4-2

The packages in the `ament_black` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ament_black --override-release-repository-push-url git@github.com:revyos-ros/ament_black-release.git` on `Thu, 13 Jun 2024 03:24:10 -0000`
